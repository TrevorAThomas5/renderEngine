...
/**
 * An entity which lacks a texture able to be rendered by the engine.
 */
public class UntexturedEntity
{
     ...
     */
    public UntexturedEntity(RawModel model, Vector3f position, float rotX, float rotY,
